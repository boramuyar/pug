...
require (
	...
	github.com/pingcap/tidb/pkg/parser v0.0.0-20260521202545-26a449413784 // indirect
	...
	github.com/wasilibs/go-pgquery v0.0.0-20260519030130-725a785941e3 // indirect
